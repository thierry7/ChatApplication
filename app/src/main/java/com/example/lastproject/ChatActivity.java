...
public class ChatActivity extends AppCompatActivity {
   ...
   // String chatID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatMessagesDb = FirebaseDatabase.getInstance().getReference().child("user")
                .child("chat").child(mChatObject.getChatId())
                .child("messages");
        ...
        mChatMessagesDb =FirebaseDatabase.getInstance().getReference().child("user").child("chat").child(mChatObject.getChatId());
    ...
    private void sendMessage(){
        ...
        final DatabaseReference newMessagebd = mChatMessagesDb.push();
        ...
        mMessage = findViewById(R.id.messageInput);
            ...
            if (!mediaUriList.isEmpty()) {
                ...
                for (String mediaUri : mediaUriList) {
                    String mediaId = newMessagebd.child("media").push().getKey();
                            ...
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    if (totalMediaUploaded == mediaUriList.size())
                                        updateDatabaseWithNewMessage(newMessagebd, newMessageMap);
